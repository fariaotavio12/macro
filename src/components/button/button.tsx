...
const buttonVariants = cva(
	"inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full border border-transparent button ring-offset-background transition-all duration-200 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/20 focus-visible:ring-offset-0 disabled:pointer-events-none disabled:opacity-60 cursor-pointer box-border",
	{
		variants: {
			variant: {
				...
				sidebar: "justify-start text-left hover:bg-sidebar-accent hover:text-sidebar-accent-foreground",
			},
			size: {
				...
				"icon-sm": "w-7 h-7 size-7 rounded-[min(var(--radius-md),12px)] in-data-[slot=button-group]:rounded-lg",
