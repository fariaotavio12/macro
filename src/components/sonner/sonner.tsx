	...
	return (
		<Sonner
			...
			toastOptions={{
				classNames: {
					toast:
						"group toast group-[.toaster]:border-border/80 group-[.toaster]:bg-card group-[.toaster]:text-card-foreground group-[.toaster]:rounded-xl group-[.toaster]:shadow-xl group-[.toaster]:shadow-foreground/5 group-[.toaster]:backdrop-blur",
