...
export const mapearMensagemErro = (erro: AxiosError<ApiErrorBody> | Error): string => {
	...
	const mensagensStatus: Record<number, string> = {
		401: "Nao autorizado. Por favor, verifique suas credenciais.",
		403: "Acesso proibido. Voce nao tem permissao para acessar este recurso.",
		404: "Recurso nao encontrado. Verifique se o endereco esta correto.",
		500: "Erro interno do servidor. Por favor, tente novamente mais tarde.",
		503: "Servico indisponivel. Por favor, tente novamente mais tarde.",
	};
