			...
			<div className="mx-auto w-full max-w-5xl space-y-24 px-4 py-16 md:px-6">
				...
				>
					<div className="flex flex-col gap-4">
						...
						<UsageCard
							title="Dialog"
							method="Use para decisões que bloqueiam o fluxo principal. Suporta placement center, right e left com tamanhos sm/md/lg/xl."
							...
							<Dialog>
								...
								<DialogContent>
									<DialogHeader>
										<DialogTitle>Confirmar ação</DialogTitle>
										<DialogDescription>
											Esta ação removerá o registro permanentemente. Deseja continuar?
										</DialogDescription>
									</DialogHeader>
									<div className="space-y-3">
									...
									<DialogFooter>
										...
										<Button onClick={() => notify.success("Ação confirmada.")}>Confirmar</Button>
									</DialogFooter>
								</DialogContent>
							</Dialog>
						</UsageCard>
								...
								<Sidebar collapsible="none" className="border-r">
									<SidebarHeader className="flex flex-row items-center gap-3 p-3">
										<div className="bg-sidebar-primary text-sidebar-primary-foreground flex aspect-square size-8 items-center justify-center rounded-lg">
											<AppBrandIcon className="h-4 w-4" />
										</div>
