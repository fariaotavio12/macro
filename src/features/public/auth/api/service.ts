...
export const useAuthUser = () => {
	return useMutation({
		mutationFn: authUser,
		onError: (e: unknown) => {
			notify.error(getApiErrorMessage(e, "Nao foi possivel autenticar o usuario"));
		},
	});
};
...
export const useSendEmailVerificationCode = () => {
	return useMutation({
		...
		onError: (e: unknown) => {
			notify.error(getApiErrorMessage(e, "Nao foi possivel enviar o codigo de verificacao"));
		},
		onSuccess: () => {
			notify.success("Codigo de verificacao enviado para o e-mail informado.");
		},
	});
};
...
export const useRegisterUser = () => {
	return useMutation({
		...
		onError: (e: unknown) => {
			notify.error(getApiErrorMessage(e, "Nao foi possivel registrar o usuario"));
		},
		onSuccess: () => {
			notify.success("Usuario registrado com sucesso.");
		},
	});
};

const getUserMe = async (): Promise<CurrentUserResponseDto> => {
...
export const useResetPassword = () => {
	return useMutation({
		...
		onError: (e: unknown) => {
			notify.error(getApiErrorMessage(e, "Nao foi possivel redefinir a senha"));
		},
		onSuccess: () => {
...
export const useConfirmPasswordChange = () =>
	useMutation({
		...
		onError: (e: unknown) => {
			notify.error(getApiErrorMessage(e, "Nao foi possivel alterar a senha"));
		},
	});

const completeRegisterGoogle = async (value: CompleteRegisterDtoRequest): Promise<RegisterUserResponseDto> => {
	const { data } = await api.post("/auth/register/google/complete", value);
	return data;
};

export const useCompleteRegisterGoogle = () => {
	return useMutation({
		mutationFn: completeRegisterGoogle,
		onError: (e: unknown) => {
			notify.error(getApiErrorMessage(e, "Nao foi possivel completar o registro"));
		},
		onSuccess: () => {
			notify.success("Registro completado com sucesso.");
			tanStackQueryClient.invalidateQueries({ queryKey: authKeys.me() });
		},
	});
};
...
export const useActivateUser = () => {
	return useMutation({
		...
		onSuccess: () => {
			tanStackQueryClient.invalidateQueries({ queryKey: authKeys.users() });
			notify.success("Usuario ativado com sucesso");
		},
		onError: (e: unknown) => {
			notify.error(getApiErrorMessage(e, "erro inesperado"));
		},
...
export const useDeactivateUser = () => {
	return useMutation({
		...
		onSuccess: () => {
			tanStackQueryClient.invalidateQueries({ queryKey: authKeys.users() });
			notify.success("Usuario desativado com sucesso");
		},
		onError: (e: unknown) => {
			notify.error(getApiErrorMessage(e, "erro inesperado"));
		},
